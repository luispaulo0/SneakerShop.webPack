                ...
                <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src={imgPromo} className="d-block w-100" width="400" height="400" />
                        </div>
                        <div className="carousel-item">
                            <img src={imgPromo2} className="d-block w-100" width="400" height="400"/>
                        </div>
                        <div className="carousel-item">
                            <img src={imgPromo3} className="d-block w-100"width="400" height="400"/>
                        </div>
                    </div>
